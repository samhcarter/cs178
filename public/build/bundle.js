...
var app = (function () {
    ...
    /* src/Icon.svelte generated by Svelte v3.55.1 */

    const file$1 = "src/Icon.svelte";

    function create_fragment$1(ctx) {
    	let svg;
    	let raw_value = /*icon*/ ctx[0].path + "";
    	let svg_class_value;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(svg, file$1, 19, 2, 788);
    		},
    ...
    // (67:3) {#each todoList as item, index}
    function create_each_block(ctx) {
    	let div1;
    	let span;
    	let t0_value = /*item*/ ctx[9].task + "";
    	let t0;
    	let t1;
    	let div0;
    	let button0;
    	...
    	function click_handler_1() {
    		return /*click_handler_1*/ ctx[8](/*index*/ ctx[11]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			attr_dev(span, "class", "todo__text svelte-yeolh");
    			add_location(span, file, 70, 4, 2994);
    			attr_dev(button0, "class", "complete svelte-yeolh");
    			add_location(button0, file, 74, 3, 3226);
    			attr_dev(button1, "class", "delete svelte-yeolh");
    			add_location(button1, file, 77, 3, 3333);
    			attr_dev(div0, "class", "todo__buttons svelte-yeolh");
    			add_location(div0, file, 71, 4, 3042);
    			attr_dev(div1, "class", "todo svelte-yeolh");
    			toggle_class(div1, "completed", /*item*/ ctx[9].completed);
    			add_location(div1, file, 69, 2, 2938);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*todoList*/ 2) && t0_value !== (t0_value = /*item*/ ctx[9].task + "")) set_data_dev(t0, t0_value);

    			if (!current || dirty & /*todoList*/ 2) {
    				toggle_class(div1, "completed", /*item*/ ctx[9].completed);
    			}
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(67:3) {#each todoList as item, index}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-yeolh");
    			add_location(h1, file, 50, 1, 2242);
    			add_location(h2, file, 54, 1, 2459);
    			attr_dev(input, "placeholder", "Enter to-do");
    			attr_dev(input, "class", "svelte-yeolh");
    			add_location(input, file, 58, 3, 2554);
    			attr_dev(span, "class", "svelte-yeolh");
    			add_location(span, file, 61, 44, 2678);
    			attr_dev(button, "class", "add-todo svelte-yeolh");
    			add_location(button, file, 61, 3, 2637);
    			attr_dev(form, "class", "svelte-yeolh");
    			add_location(form, file, 57, 1, 2513);
    			attr_dev(div, "class", "todos svelte-yeolh");
    			add_location(div, file, 65, 1, 2732);
    			attr_dev(main, "class", "svelte-yeolh");
    			add_location(main, file, 47, 2, 2109);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*number*/ 4) set_data_dev(t3, /*number*/ ctx[2]);

    			if (dirty & /*newItem*/ 1 && input.value !== /*newItem*/ ctx[0]) {
    				set_input_value(input, /*newItem*/ ctx[0]);
    			}

    			if (dirty & /*todoList, remove, complete*/ 50) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function add() {
    		...
    		if (newItem !== "") {
    			$$invalidate(1, todoList = [...todoList, { task: newItem, completed: false }]);
    			$$invalidate(0, newItem = "");

    			// BELOW: #Reactive, updates TODO item count in real time (Added by Sam)
    			$$invalidate(2, number++, number);
    		}
    	}
    	...
    	const click_handler = index => complete(index);
